    ...
    override fun onBindViewHolder(holder: CommonRecyclerViewHolder, position: Int) {
        if (mLongListener != null) {
            holder.itemView.setOnLongClickListener({
                val mPosition = holder.layoutPosition
                mLongListener!!.onItemLongClickListener(holder.itemView, mPosition)
                true
            })
        }
        if (mListener != null) {
            holder.itemView.setOnClickListener({
                val mPosition = holder.layoutPosition
                mListener!!.onItemClickListener(holder.itemView, mPosition)
            })
        }
