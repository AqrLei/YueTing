...
class TabReadFragment : MvpContract.MvpFragment<TabReadPresenter, YueTingActivity>()
    ...
    private fun initView() {
        ...
        mReadData.add(BookMessage("这是书名吧1", null))
        mReadData.add(BookMessage("这是书名吧2", null))
        mReadData.add(BookMessage("这是书名吧3", null))
        mReadData.add(BookMessage("这是书名吧4", null))
        mReadData.add(BookMessage("这是书名吧5", null))
        mReadData.add(BookMessage("这是书名吧6", null))
        mReadData.add(BookMessage("这是书名吧7", null))
        mReadData.add(BookMessage("这是书名吧7", null))
        mReadData.add(BookMessage("这是书名吧7", null))
        mReadData.add(BookMessage("这是书名吧7", null))
        mReadData.add(BookMessage("这是书名吧7", null))
